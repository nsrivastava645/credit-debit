import { StatusCodes } from "./UtilConstants.js";
export default function responseHandler(status, statusCode, title, message = null, res, apiResponse, req, isInternalResponse = false) {
