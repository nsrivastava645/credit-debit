...
class DebitController {
    async DebitFromCard (req, res) {
        ...
        if(parseInt(txnType) === UtilConstants.Constants.txnTypes.credit)
            return responseHandler(false, UtilConstants.StatusCodes.BadRequest, 'Error', 'Kindly use the credit service to add credits', res, null, req, false);
        ...
        // Debit Logic
        /* Debit logic where we debit that amount from the user's card 
